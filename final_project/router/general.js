...
// Get the book list available in the shop using prmoise
public_users.get('/', function (req, res) {
...
//         if (selecteBook) {
//             return res.status(200).send(selecteBook)
...
//             return res.status(200).send(JSON.stringify(booksOfAuther))
//         } else return res.status(403).send({ mmessage: 'book not found' })
//     }
//     return res.status(403).send({ mmessage: 'invalid author' })
// });
...
//         } else return res.status(403).send({ mmessage: 'book not found' })
//     }
//     return res.status(403).send({ mmessage: 'invalid title' })
// });
